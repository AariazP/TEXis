...
\multirow{9}{\linewidth}{\centering\includegraphics[width=\linewidth,height=4.5cm,keepaspectratio]{tablas-images/cp1/torres/torre-1.png}} \\ \cline{1-1}
\textbf{MODELO:} Desconocido & \\ \cline{1-1}
\textbf{MARCA:} HP & \\ \cline{1-1}
\textbf{CÓDIGO DE INVENTARIO:} 7 24390 49867 3 & \\ \cline{1-1}
\textbf{NÚMERO EN CPD:} 14 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
...
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{PROPÓSITO:} Hipervisor XCP-ng} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{OPORTUNIDAD DE USO:} Proyectos del \GRID} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{OBSERVACIONES:} Sin modelo. Equipo adaptado para virtualización.} & \\ \hline
\end{tabular}
\end{table}
...
\textbf{NÚMERO EN CPD:} 12 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
- 8 USB (4 frontal, 4 trasera)
- Audio y micrófono
...
\textbf{NÚMERO EN CPD:} 13 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
- 8 USB (4 frontal, 4 trasera)
- Audio y micrófono
...
\multicolumn{2}{|l|}{\textbf{DESCRIPCIÓN FÍSICA:} Servidor tipo torre} \\ \hline
\textbf{TIPO DE RECURSO:} Torre &
\multirow{9}{\linewidth}{\centering\includegraphics[width=\linewidth,height=4.5cm,keepaspectratio]{tablas-images/cp1/torres/torre-2.png}} \\ \cline{1-1}
\textbf{MODELO:} G9 & \\ \cline{1-1}
\textbf{MARCA:} HP & \\ \cline{1-1}
\textbf{CÓDIGO DE INVENTARIO:} 72992 & \\ \cline{1-1}
\textbf{NÚMERO EN CPD:} 22 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
...
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{PROPÓSITO:} Hipervisor XCP-ng} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{OPORTUNIDAD DE USO:} Proyectos del \GRID} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{OBSERVACIONES:} Equipo adaptado para virtualización.} & \\ \hline
\end{tabular}
\end{table}
...
\textbf{NÚMERO EN CPD:} 21 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
- 9 USB (4 frontal, 5 trasera)
- Audio y micrófono
...
\multicolumn{2}{|l|}{\textbf{DESCRIPCIÓN FÍSICA:} Servidor tipo torre} \\ \hline
\textbf{TIPO DE RECURSO:} Torre &
\multirow{9}{\linewidth}{\centering\includegraphics[width=\linewidth,height=4.5cm,keepaspectratio]{tablas-images/cp1/torres/ATX.png}} \\ \cline{1-1}
\textbf{MODELO:} Argom tech & \\ \cline{1-1}
\textbf{MARCA:} Argom tech & \\ \cline{1-1}
\textbf{CÓDIGO DE INVENTARIO:} Sin código & \\ \cline{1-1}
\textbf{NÚMERO EN CPD:} 11 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
...
\multirow{10}{\linewidth}{\centering\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{tablas-images/cp1/racks/rack-1.png}} \\ \cline{1-1}
\textbf{MODELO:} System x3250 M4 & \\ \cline{1-1}
\textbf{MARCA:} IBM & \\ \cline{1-1}
\textbf{CÓDIGO DE INVENTARIO:} 7 24390 50981 & \\ \cline{1-1}
\textbf{NUMERO EN CPD:} 55 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
...
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{PROPÓSITO:} Prestación de servicios de cómputo} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{IMPACTO:} 
- Servicios a estudiantes
- Máquinas virtuales para prácticas} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{OBSERVACIONES:} Ninguna} & \\ \hline
\end{tabular}
\end{table}
...
\setlength{\tabcolsep}{3pt}
\renewcommand{\arraystretch}{1.1}
\caption{Ficha técnica --- Rack 2}\label{tab:rack-2}
\begin{tabular}{|p{0.72\textwidth}|p{0.24\textwidth}|}
\hline
\multicolumn{2}{|l|}{\textbf{DESCRIPCIÓN FÍSICA:} Servidor tipo rack} \\ \hline
\textbf{TIPO DE RECURSO:} Servidor &
...
\textbf{NUMERO EN CPD:} 54 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
- Procesador Intel Xeon E3-1220v2
- Controlador SATA integrado
...
\setlength{\tabcolsep}{3pt}
\renewcommand{\arraystretch}{1.1}
\caption{Ficha técnica --- Rack 3}\label{tab:rack-3}
\begin{tabular}{|p{0.72\textwidth}|p{0.24\textwidth}|}
\hline
\multicolumn{2}{|l|}{\textbf{DESCRIPCIÓN FÍSICA:} Servidor tipo rack} \\ \hline
\textbf{TIPO DE RECURSO:} Servidor &
...
\textbf{MARCA:} IBM & \\ \cline{1-1}
\textbf{CÓDIGO DE INVENTARIO:} 7 24390 50980 & \\ \cline{1-1}
\textbf{NUMERO EN CPD:} 53 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
- Procesador Intel Xeon E3-1220v2
- Controlador SATA integrado
...
\setlength{\tabcolsep}{3pt}
\renewcommand{\arraystretch}{1.1}
\caption{Ficha técnica --- Rack 4}\label{tab:rack-4}
\begin{tabular}{|p{0.72\textwidth}|p{0.24\textwidth}|}
\hline
\multicolumn{2}{|l|}{\textbf{DESCRIPCIÓN FÍSICA:} Servidor tipo rack} \\ \hline
\textbf{TIPO DE RECURSO:} Servidor &
...
\textbf{NUMERO EN CPD:} 52 & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
- Procesador Intel Xeon E3-1220v2
- Controlador SATA integrado
...
\multirow{9}{\linewidth}{\centering\includegraphics[width=\linewidth,height=4.5cm,keepaspectratio]{tablas-images/cp1/NAS/nas-1.png}} \\ \cline{1-1}
\textbf{MODELO:} TS-832PX-4G & \\ \cline{1-1}
\textbf{MARCA:} QNAP & \\ \cline{1-1}
\textbf{CÓDIGO DE INVENTARIO:} Por definir & \\ \cline{1-1}
\textbf{FECHA DE ADQUISICIÓN:} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
...
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{PROPÓSITO:} Almacenamiento compartido y redundante en red} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{IMPACTO:} - Sin NAS: no hay backups ni acceso a archivos} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{OBSERVACIONES:} Ninguna} & \\ \hline
\end{tabular}
\end{table}
\noindent
...
\multirow{9}{\linewidth}{\centering\includegraphics[width=\linewidth,height=4.5cm,keepaspectratio]{tablas-images/cp1/firewall/firewall.png}} \\ \cline{1-1}
\textbf{MODELO:} PowerEdge T100 & \\ \cline{1-1}
\textbf{MARCA:} DELL & \\ \cline{1-1}
\textbf{CÓDIGO DE INVENTARIO:} 7 24390 46288 9 & \\ \cline{1-1}
\textbf{NÚMERO EN CPF:} No especificado & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{ESPECIFICACIONES TÉCNICAS}} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{
...
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{PROPÓSITO:} Seguridad de la red de servidores} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{IMPACTO:} - Protege equipos de usuarios no autorizados} & \\ \cline{1-1}
\multicolumn{1}{|p{0.72\textwidth}|}{\textbf{OBSERVACIONES:} Ninguna} & \\ \hline
\end{tabular}
\end{table}