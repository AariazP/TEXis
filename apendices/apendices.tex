...
\FloatBarrier\chapter{Ambiente de Benchmarking}
\section{Características del entorno de benchmarking}\label{sec:env-benchmarking}
...
\section{Ejemplo de solicitud de recursos tecnológicos \.yml}
\begin{figure}[H]
    \centering
