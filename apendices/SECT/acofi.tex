...
\begin{figure}[H]
    ...
    \begin{tcolorbox}[
        ...
        \includegraphics[width=0.95\textwidth,keepaspectratio]{apendices/PORTADA-ART/ACOFI-PORTADA.png}
    \end{tcolorbox}
    \caption{Portada de la ponencia ACOFI}\label{fig:acofi-portada}
\end{figure}
\FloatBarrier
