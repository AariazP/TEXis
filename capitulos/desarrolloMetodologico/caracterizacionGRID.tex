...
\section{Análisis de stakeholders del GRID}\label{sec:stakeholders}
\noindent
...
Este trabajo se enfoca en la identificación de una tecnología de contenerización que agregue valor a los procesos del grupo, beneficiando a docentes, estudiantes y cualquier parte interesada que participe en los proyectos y actividades desarrolladas por este grupo de investigación.
...
\begin{table}[H]
\centering
\sffamily\scriptsize % Fuente sans-serif más pequeña para tablas
\setlength{\tabcolsep}{3pt} % Espacio entre columnas ajustado
\renewcommand{\arraystretch}{1.1} % Espaciado vertical mejorado
\begin{tabular}{|p{0.28\textwidth}|p{0.68\textwidth}|} % Ancho más amplio
\hline
