...
En el anexo~\ref{tab:elementos-negocio-archimate} se especifica el uso y significado de cada uno de los elementos y relaciones que componen el lenguaje, facilitando la creación de modelos comprensibles. Además, ArchiMate proporciona su propia guía de usuario que puede encontrarse \href{https://www.archimatetool.com/downloads/archi/Archi%20User%20Guide.pdf}{aquí}.
...
\section{Diseño por capas de la solución}\label{sec:disenio-por-capas}
\noindent
...
\subsection{Capa de virtualización}\label{sec:virtualizacion-capa}
\noindent
