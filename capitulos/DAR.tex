\chapter*{Análisis de Decisiones y Resolución (DAR)}
\addcontentsline{toc}{chapter}{Análisis de Decisiones y Resolución (DAR)}\label{cap:dar}
...
\subsection*{3.2 Tipo de licencia}
...
\section*{4. Tecnología VBC ganadora}
