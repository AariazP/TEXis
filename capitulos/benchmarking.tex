\chapter*{Pruebas de Benchmarking}
\addcontentsline{toc}{chapter}{Pruebas de Benchmarking}\label{cap:benchmarking}

\section*{1. Definición de las pruebas}
\addcontentsline{toc}{section}{1. Definición de las pruebas}
...
\addcontentsline{toc}{section}{2. Construcción de las pruebas}
...
\addcontentsline{toc}{section}{3. Resultados de las pruebas}
...
\addcontentsline{toc}{section}{4. Métricas de rendimiento}
...
\addcontentsline{toc}{section}{5. Análisis de los resultados}
